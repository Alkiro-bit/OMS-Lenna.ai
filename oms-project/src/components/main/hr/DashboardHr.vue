...
const statsCards = computed(() => {
  return [
    {
      key: "pengajuan",
      value: dashboardData.summary.totalSubmission, // ganti dengan data semua submission dari API yang masuk.
    ...
    {
      key: "declined",
      value: dashboardData.summary.totalDeclined, // ganti dengan data form yang suda di validasi TAPI = "Invalid" sama HR
      label: "Overtime Declined",
    },
    {
      key: "pending",
      value: dashboardData.summary.totalPending, // ganti dengan data form yang belum di validasi sama HR (statusnya masih "Pending")
...
const fetchDashboardData = async () => {
  ...
  try {
    const response = await axios.get("http://oms-backend.test:8080/api/dashboard", {
      headers: {
